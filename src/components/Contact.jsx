...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    fetch(
      'https://docs.google.com/forms/d/e/1FAIpQLSf0-fTgr22NKJ15kdKhcSxFUTIQVvez445SGTEVqdXGgQ-mYQ/formResponse',
      {
        method: 'POST',
        mode: 'no-cors',
        body: formData,
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 max-w-5xl mx-auto">
        {/* Contact Form */}
        <div
          className="lg:col-span-2 bg-white/5 backdrop-blur-md rounded-xl p-8 shadow-xl"
          data-aos="fade-right"
        >
          {!submitted ? (
            <>
        ...
        <div
          className="bg-transparent rounded-xl p-8 shadow-2xl flex flex-col gap-6"
          data-aos="fade-left"
        >
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <span className="block text-white text-sm">
                B-303, Shantiniketan Business Center,
                <br />
